...
namespace Examen3.Controllers
{
    public class BebidaController : Controller
    {
        ...
        public BebidaController(ApplicationDbContext context, IWebHostEnvironment hostEnviroment)
        {
            _context = context;
        ...
        {
            var applicationDbContext = _context.Bebidas.Include(b => b.TipoPlatillo);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,IdTipoPlatillo,Precio,ImagenBebida")] Bebida bebida)
        {
            string rutaPrincipal = _hostEnviroment.WebRootPath;
                ...
                if(archivos.Count()>0){
                    ...
                    bebida.ImagenBebida = @"imagenes\bebidas\" + nombreArchivo + extension;
                }
                _context.Add(bebida);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            ViewData["IdTipoPlatillo"] = new SelectList(_context.TipoPlatillos, "Id", "Nombre", bebida.IdTipoPlatillo);
            return View(bebida);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,IdTipoPlatillo,Precio,ImagenBebida")] Bebida bebida)
        {
            if (id != bebida.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if(archivos.Count()>0){
                        ...
                        if(bebidaBD!=null && bebidaBD.ImagenBebida!=null){
                            var rutaImagenActual = Path.Combine(rutaPrincipal, bebidaBD.ImagenBebida);
